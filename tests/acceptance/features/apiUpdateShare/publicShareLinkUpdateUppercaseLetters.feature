@api
Feature: enforce the required number of uppercase letters in a password on share public link

  As an administrator
  I want share public link to always contain a required number of uppercase letters
