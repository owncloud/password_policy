@api
Feature: enforce the required number of lowercase letters on public share link

  As an administrator
  I want public share link to always contain a required number of lowercase letters
