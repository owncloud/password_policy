@api
Feature: enforce the required number of special characters in a password on public share link

  As an administrator
  I want public share link to always contain a required number of special characters
