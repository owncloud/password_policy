@webUI
Feature: enforce the required number of uppercase letters in a password when creating a public share link
  ...
  Scenario Outline: user shares a folder with a enough uppercase letters
  ...
  Scenario Outline: user tries to share a folder with too few upper case letters
