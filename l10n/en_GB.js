OC.L10N.register(
    ...
    "days until link expires if password is set" : "days until link expires if password is set",
    "days until link expires if password is not set" : "days until link expires if password is not set",
    "Save" : "Save",
